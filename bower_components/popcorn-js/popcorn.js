(function(global, document) {
  ...
  Popcorn.p = Popcorn.prototype = {
    ...
    init: function( entity, options ) {
      ...
      //  Create an audio or media element property reference
      ...
      //  function to fire when media is ready
      var isReady = function() {

        // chrome bug: http://code.google.com/p/chromium/issues/detail?id=119598
        // it is possible the media's time is less than 0
  ...
  Popcorn.dom = {
    ...
    //
    //  eg.
    //  Popcorn.dom.find("media") returns the first media element
