...
(function( Popcorn, document ) {
  ...
  // How often (ms) to update the media's current time,
  // and by how much (s).
  ...
  //   #t=,100   -- a null media of 100s (starts at 0s)
  //   #t=5,100  -- a null media of 100s, which starts at 5s (i.e., 95s duration)
  ...
  // We'll attempt to support a mime type of media/x-nullvideo
  Popcorn.HTMLNullVideoElement.canPlayType = function( type ) {
    return type === "media/x-nullvideo" ? "probably" : EMPTY_STRING;
  };
