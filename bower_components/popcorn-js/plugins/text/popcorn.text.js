...
(function ( Popcorn ) {
   ...
   *      start: 5, // seconds
   *      end: 15, // seconds
   *      text: 'This media made exclusively for drumbeat.org',
   *      target: 'textdiv'
   *     })
   *
   ...
   *      start: 15, // seconds
   *      end: 20, // seconds
   *      text: '<p>This media made <em>exclusively</em> for drumbeat.org</p>',
   *      target: 'textdiv'
   *    })
   *
   ...
   *      start: 30, // seconds
   *      end: 40, // seconds
   *      text: 'This will be overlayed on the media',
   *     })
   **/
  ...
  function createSubtitleContainer( context, id ) {
    ...
    var updatePosition = function() {
      ...
      // the media element must have height and width defined
      style.fontSize = "18px";
  ...
  Popcorn.plugin( "text", {
     ...
     * of the media  reaches the start time provided by the
     * options variable
     */
     ...
     * of the media  reaches the end time provided by the
     * options variable
     */
