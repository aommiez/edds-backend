...
asyncTest( "Popcorn.smart player selector", function() {
  ...
  equal( thisIsNotSparta.media.nodeName, "VIDEO", "no player was found for this URL, default to media element" );
  plus();
...
asyncTest( "Popcorn.smart - audio and media elements", function() {
  ...
  equal( instanceDiv.children[ 0 ].nodeName, "VIDEO", "Smart player correctly creates media elements" );
  p.destroy();
  plus();
