asyncTest( "Popcorn 0.3 JSON Parser Plugin", function () {
  ...
  poppercorn.parseJSON("data/media.json");
  poppercorn.pause();
  ...
  poppercorn.exec( 3, function() {
    if ( !finished ) {
      ...
      plus();
      equal( $("#video-iframe-container").children().length, 2, '$("#media-iframe-container").children().length' );
      plus();
      equal( $("#video-map-container").children().length, 1, '$("#media-map-container").children().length'  );
      plus();
      equal( $("#video-footnote-container").children().length, 2, '$("#media-footnote-container").children().length'  );
      plus();
