...
asyncTest( "loadstart", 1, function() {
  var p = Popcorn.vimeo( "#player", "http://player.vimeo.com/media/11336811" )
...
asyncTest( "URL Options Check", 1, function() {
  var options = {
      ...
      p = Popcorn.vimeo( "#player", "http://player.vimeo.com/media/11336811?title=0&byline=0&portrait=0&color=333&autoplay=1&loop=1" );
...
asyncTest( "Known good short URL", 1, function() {
  ...
  var url = "http://vimeo.com/11336811",
      expected = "http://player.vimeo.com/media/11336811",
