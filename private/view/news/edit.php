...
$item = $db->get("news", "*", ["news_id"=> $params["news_id"]]);
?>
    <h3>Edit news</h3>
    <div class="innerLR">
        <div class="row">
...
<!--                    </div>-->
                        ...
                        <div class="innerLR">
                            <form class="form-horizontal" role="form" method="post" enctype="multipart/form-data">
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-10">
                                        <input type="text" name="news_name" class="form-control" placeholder="News name" required="" value="<?php echo $item["news_name"];?>">
                                    </div>
                                </div>
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-10">
                                        <div class="fileupload fileupload-new margin-none" data-provides="fileupload">
                                            <div class="input-group">
                                                ...
                                                <input type="file" name="news" class="margin-none" />
                ...
                <div class="widget widget-heading-simple widget-body-white">
                    ...
                    <div class="widget-body">
                        <div class="innerLR">
                            <strong>Image</strong>
                            <div><img src="<?php echo \Main\Helper\URL::absolute("/public/news/{$item["news_path"]}");?>" width="100%"></div>
                            <strong>Thumbnail</strong>
                            <div><img src="<?php echo \Main\Helper\URL::absolute("/public/news/{$item["news_thumbnail_path"]}");?>" width="100%"></div>
                        </div>
                    </div>
                </div>
