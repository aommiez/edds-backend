...
$item = $db->get("event", "*", ["event_id"=> $params["event_id"]]);
?>
    <h3>Edit event</h3>
    <div class="innerLR">
        <div class="row">
...
<!--                    </div>-->
                        ...
                        <div class="innerLR">
                            <form class="form-horizontal" role="form" method="post" enctype="multipart/form-data">
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-10">
                                        <input type="text" name="event_name" class="form-control" placeholder="event name" required="" value="<?php echo $item["event_name"];?>">
                                    </div>
                                </div>
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-10">
                                        <div class="fileupload fileupload-new margin-none" data-provides="fileupload">
                                            <div class="input-group">
                                                ...
                                                <input type="file" name="event" class="margin-none" />
                                    ...
                                    <div class="col-sm-10">
                                        <div class="fileupload fileupload-new margin-none" data-provides="fileupload">
                                            <div class="input-group">
                                                ...
                                                <span class="fileupload-new">Select file</span>
                                                <span class="fileupload-exists">Change</span>
                                                <input type="file" name="thumbnail" class="margin-none" />
                                                </span><a href="#" class="btn fileupload-exists" data-dismiss="fileupload">Remove</a></span>
                                            </div>
                                        </div>
                                    </div>
                ...
                <div class="widget widget-heading-simple widget-body-white">
                    <!-- Widget heading -->
                    <div class="widget-head">
                        <h4 class="heading">Old file</h4>
                    </div>
                    <!-- // Widget heading END -->
                    <div class="widget-body">
                        <div class="innerLR">
                            <strong>Image</strong>
                            <div><img src="<?php echo \Main\Helper\URL::absolute("/public/event/{$item["event_path"]}");?>" width="100%"></div>
                            <strong>Thumbnail</strong>
                            <div><img src="<?php echo \Main\Helper\URL::absolute("/public/event/{$item["event_thumbnail_path"]}");?>" width="100%"></div>
                        </div>
                    </div>
                </div>
